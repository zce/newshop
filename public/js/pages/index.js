...
function scrollFloorView () {
  ...
  if (ling > 1200 && ling < 1600) { // 第一层的数字隐藏，文字显示，其他兄弟元素的li数字显示，文字隐藏
...
function rotateElement (element, angle) {
  ...
  if (element.css('MozTransform') != undefined) { element.css('MozTransform', rotate) } else if (element.css('WebkitTransform') != undefined) { element.css('WebkitTransform', rotate) }
}
